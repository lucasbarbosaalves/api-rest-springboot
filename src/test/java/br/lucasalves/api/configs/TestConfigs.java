package br.lucasalves.api.configs;
...
public class TestConfigs {
	...
	public static final String ORIGIN_ERUDIO = "http://localhost:3000";
	public static final String ORIGIN_SEMERU = "http://localhost:8808";
